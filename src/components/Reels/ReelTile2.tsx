...
import { VideoData } from './ReelSection2';
import CircleUrlProfile from '../Feed/CircleUrlProfile';
import LikeSection from '../Feed/SwipeLowerComp/LikeSection';
import CommentSection from '../Feed/SwipeLowerComp/CommentSection';
                ...
                <View
                    ...
                    <View
                        ...
                        <View className="flex flex-row px-4 pb-2">
                            {/* post details */}
                            <View className="flex items-start justify-end flex-1">
                                ...
                                <TouchableOpacity className=" bg-black/25 flex flex-row items-center py-1 px-2 rounded-lg my-1" onPress={()=>{navigation.navigate('ReelsAudio',{songDetails: data?.sound })}}>
                                <Image
